...
const { signup, sendOTP, login, getNotifications, forgotPassword, changePassword, userTypes, logout, updateDetails, getTrucks, getEquipments, getEquipment, getTruck, getDetails } = require('../Controllers/user.controller');

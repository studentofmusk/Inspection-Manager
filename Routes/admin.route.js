const { adminSignup, getAdminNotification, userApprove, removeUser, setAdmin, uploadEquipmentImage, createEquipment, createTruck, updateTruck, deleteTruck, deleteEquipment, updateEquipment, getFireFighters } = require('../Controllers/admin.controller');
...
admin_routes.get('/raise-admin-approval', userauth, adminSignup );
admin_routes.get('/get-notifications', adminauth, getAdminNotification );
admin_routes.get('/get-firefighters', adminauth, getFireFighters );
...
admin_routes.post('/update-equipment', adminauth, uploadEquipmentImage.single('image'), updateEquipment);

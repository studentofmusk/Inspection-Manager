const { adminSignup, getAdminNotification, userApprove, removeUser, setAdmin, uploadEquipmentImage, createEquipment, createTruck, updateTruck, deleteTruck, deleteEquipment, updateEquipment } = require('../Controllers/admin.controller');
